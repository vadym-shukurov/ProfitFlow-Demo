...
class StatusPagesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    listStatusPages(pageOffset, pageLimit, include, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
            const localVarPath = "/api/v2/statuspages";
...
class StatusPagesApi {
    ...
    listStatusPages(param = {}, options) {
        const requestContextPromise = this.requestFactory.listStatusPages(param.pageOffset, param.pageLimit, param.include, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
